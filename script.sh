...
mosquitto_pub -r -h $mqtt_host -t homeassistant/sensor/ecowatt/today/config -m '{"name": "Etat réseau aujourd'hui", "state_topic": "ecowatt/status", "value_template": "{{ value_json.today}}", "unique_id": "mqtt.ecowatt.today", "device": {"model": "Ecowatt", "identifiers": ["mqtt-ecowatt"], "name": "Ecowatt", "manufacturer": "Ecowatt"}}'
mosquitto_pub -r -h $mqtt_host -t homeassistant/sensor/ecowatt/tomorrow/config -m '{"name": "Etat réseau demain", "state_topic": "ecowatt/status", "value_template": "{{ value_json.tomorrow}}", "unique_id": "mqtt.ecowatt.tomorrow", "device": {"model": "Ecowatt", "identifiers": ["mqtt-ecowatt"], "name": "Ecowatt", "manufacturer": "Ecowatt"}}'
