...
mosquitto_pub -r -h $mqtt_host -t homeassistant/sensor/beem/totalMonth/config -m '{"name": "totalMonth", "device_class": "energy", "state_class": "total_increasing", "unit_of_measurement": "Wh", "state_topic": "'${mqtt_topic}'", "value_template": "{{ value_json.totalMonth }}", "unique_id": "mqtt.beem.totalMonth", "device": {"model": "Beem", "identifiers": ["mqtt-beem"], "name": "Beem", "manufacturer": "Beem"}}'
...
mosquitto_pub -r -h $mqtt_host -t homeassistant/sensor/beem/totalDay/config -m '{"name": "totalDay", "device_class": "energy", "state_class": "total_increasing", "unit_of_measurement": "Wh", "state_topic": "'${mqtt_topic}'", "value_template": "{{ value_json.totalDay }}", "unique_id": "mqtt.beem.totalDay", "device": {"model": "Beem", "identifiers": ["mqtt-beem"], "name": "Beem", "manufacturer": "Beem"}}'
